    ...
    <div className="bg-[#171E37] min-h-screen flex items-center justify-center pt-24 relative">
      ...
      <div className="text-center space-y-10 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Pilha 1 */}
          <div className="p-6  border border-yellow-400/30 rounded-lg hover:border-yellow-400/50 hover:shadow-lg hover:shadow-yellow-400/20 transition-all duration-300">
          ...
          <div className="p-6  border border-yellow-400/30 rounded-lg hover:border-yellow-400/50 hover:shadow-lg hover:shadow-yellow-400/20 transition-all duration-300">
            ...
            <div className="flex justify-center space-x-4 sm:space-x-6 m-8">
        ...
        ></iframe>
          ...
          <p className="text-sm text-gray-400">
            Endereço disponível no mapa acima diretamente do Google Maps.
          </p>
      </div>
    </div>
  );
