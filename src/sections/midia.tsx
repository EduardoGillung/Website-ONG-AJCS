...
const Midia = () => {
  const mediaItems = [
    ...
    },
    {
      ...
      hoverColor: "hover:from-[#FF8C4B] hover:to-[#FFA270]",
      category: "Atrações",
            ...
            >
              ...
              <div className="p-6">
                <div className="relative bg-gray-100 rounded-2xl h-48 mb-6 overflow-hidden group">
                  {/* Imagem de fundo como prévia do vídeo */}
                  <div 
                  ...
                  >
                    <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
                      <div className="text-center">
                        <button className="w-16 h-16 bg-white/80 rounded-full flex items-center justify-center mx-auto shadow-lg group-hover:scale-110 transition-transform duration-300">
