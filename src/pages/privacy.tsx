    ...
    <div className="min-h-screen bg-[#000928]">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <div className="max-w-6xl mx-auto">
          <div className="bg-white/5 backdrop-blur-sm rounded-3xl p-6 sm:p-8 md:p-10 lg:p-12 border border-white/10 shadow-2xl">
            ...
            <div className="space-y-6 sm:space-y-8 text-gray-300 leading-relaxed">
              <section>
                <h2 className="text-xl sm:text-2xl font-bold text-yellow-400 mb-3 sm:mb-4">1. Informações Coletadas</h2>
                <p className="text-base sm:text-lg">
                  Coletamos apenas as informações necessárias para fornecer nossos serviços, incluindo:
                </p>
                <ul className="list-disc list-inside mt-3 space-y-2 ml-4 sm:ml-6">
              ...
              <section>
                <h2 className="text-xl sm:text-2xl font-bold text-yellow-400 mb-3 sm:mb-4">2. Como Usamos Suas Informações</h2>
                <p className="text-base sm:text-lg">
              ...
              <section>
                <h2 className="text-xl sm:text-2xl font-bold text-yellow-400 mb-3 sm:mb-4">3. Compartilhamento de Informações</h2>
                <p className="text-base sm:text-lg">
              ...
              <section>
                <h2 className="text-xl sm:text-2xl font-bold text-yellow-400 mb-3 sm:mb-4">4. Segurança dos Dados</h2>
                <p className="text-base sm:text-lg">
              ...
              <section>
                <h2 className="text-xl sm:text-2xl font-bold text-yellow-400 mb-3 sm:mb-4">5. Cookies e Tecnologias Similares</h2>
                <p className="text-base sm:text-lg">
              ...
              <section>
                <h2 className="text-xl sm:text-2xl font-bold text-yellow-400 mb-3 sm:mb-4">6. Seus Direitos</h2>
                <p className="text-base sm:text-lg">
              ...
              <section>
                <h2 className="text-xl sm:text-2xl font-bold text-yellow-400 mb-3 sm:mb-4">7. Alterações nesta Política</h2>
                <p className="text-base sm:text-lg">
              ...
              <section>
                <h2 className="text-xl sm:text-2xl font-bold text-yellow-400 mb-3 sm:mb-4">8. Contato</h2>
                <p className="text-base sm:text-lg">
